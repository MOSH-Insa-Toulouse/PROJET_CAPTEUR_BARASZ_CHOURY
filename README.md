...
Réalisation de la carte PCB sur KiCad  
    ...
    - Schéma electrique du circuit sur eeschema. Sur ce eeschema, vous trouverez un amplificateur transimpédance, l'écran OLED,
      le module Bluetooth et l'encodeur rotatoire. En haut à droite les pins de la carte Arduino sont représentées.  
